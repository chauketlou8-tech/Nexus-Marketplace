...
export default function Header({ tab, setTab, search, setSearch, user }: HeaderProps) {
    return (
        <div className="flex justify-between items-center w-full px-4 py-2 gap-4 sticky top-0 left-0 h-[80px] bg-white border-b border-gray-200 z-[9999999999] overflow-hidden">
            <Logo/>
